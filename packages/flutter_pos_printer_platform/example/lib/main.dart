...
void _agentLog(String hypothesisId, String message, Map<String, dynamic> data) {
  try {
    ...
    File(r'c:\src\projects\snack_burger\debug-fbe756.log')
...
void main() {
  // #region agent log
  _agentLog('A', 'example_app_start', {
    'escPosPackage': 'esc_pos_utils_plus',
...
class _MyAppState extends State<MyApp> {
  ...
  Future _printReceiveTest() async {
    // #region agent log
    _agentLog('B', 'print_test_start', {
      'printerType': selectedPrinter?.typePrinter.toString(),
