...
PaperImageSize toPixel(PaperImageSize image, {required int paperWidth, required int dpi, required bool isTspl}) {
  ...
  return PaperImageSize(width: targetWidthPx, height: targetHeightPx);
}
