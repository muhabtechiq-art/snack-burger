          ...
          builder: (context, setDialogState) {
            ...
            Future<void> handleReject() async {
              ...
              try {
                ...
                await rejectOrder(context: dialogContext, order: order);
                ...
                if (dialogContext.mounted) {
                  ...
                  ScaffoldMessenger.of(dialogContext).showSnackBar(
                    ...
                    SnackBar(content: Text('تعذّr رفض الطلب: $e')),
            ...
            Future<void> handleAccept() async {
              ...
              try {
                ...
                await acceptOrder(context: dialogContext, order: order);
                ...
                if (dialogContext.mounted) {
                  ...
                  ScaffoldMessenger.of(dialogContext).showSnackBar(
                    ...
                    SnackBar(content: Text('تعذّr قبول الطلب: $e')),
